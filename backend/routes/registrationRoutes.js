...
const { registerForEvent, preRegister, exportRegistrations, getAllRegistrations, getEventRegistrations, exportEventRegistrations, verifyAttendance } = require('../controllers/registrationController');
...
router.get('/verify/:ticketId', protect, admin, verifyAttendance);
